...
public class UseMetroCard2 {

	public static void main(String[] args) {
		Scanner keyboard = new Scanner(System.in);
		// TODO Auto-generated method stub
		ArrayList<MetroCard2> metroCards = new ArrayList<MetroCard2>();
		...
		while (choice !=0){
			...
			case 1: //new MetroCard
				    ...
				    metroCards.add(new MetroCard2(amount));
				    break;
			...
			case 2:
				...
				System.out.println("To which card do you wish to add the amount? enter the id");
				 ...
				 for (MetroCard2 card : metroCards){
			...
			case 3: 
				   for (MetroCard2 card: metroCards){
					   System.out.println("card balance " + card.getCurrentBalance());
				   }
				   break;
			...
			case 7: 
				...
				for (MetroCard2 card : metroCards){
					if (card.getCardID().equals(origCardID)){
						foundOriginal = true;
						originalCard = card;
						break;
					}
				...
				if (!foundOriginal){
					...
					ArrayList<MetroCard2> equivalentCards = new ArrayList<MetroCard2>();
					for (MetroCard2 card : metroCards){
