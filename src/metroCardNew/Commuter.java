...
public class Commuter {
	private MetroCard[] cards;  //not so likely that a Commuter will purchase an unlimited number of MetroCards, use array instead of ArrayList
