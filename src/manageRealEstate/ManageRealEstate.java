		   ...
		   case 6:
			   ...
			   for(RealEstate prop: myRealEstate){
				   if(prop.getBlock().equals(blk) && prop.getLot().equals(lt)){
					   if(prop instanceof OwnedRealEstate){
						   ((OwnedRealEstate)prop).setOwner(OwnerType.CORPORATE, "RealEstate Mngrs", "1231231234", "1 Ave A", "NY", "11220");
					   }else{
						   prop= new OwnedRealEstate("RealEstate Mngrs", "1 Ave A", "NY", "11220", "1231231234", blk, lt);
					   }
				   }
			   }
			   break;
